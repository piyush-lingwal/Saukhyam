...
export const CITY_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  Nerul: { lat: 19.033, lng: 73.0297 },
  Marol: { lat: 19.1075, lng: 72.8847 },
  Kharghar: { lat: 19.048, lng: 73.0707 },
  Belapur: { lat: 19.0183, lng: 73.043 },
  Jawahar: { lat: 19.9083, lng: 73.2333 },
  Nandurbar: { lat: 21.3667, lng: 74.2333 },
  Panvel: { lat: 18.9894, lng: 73.1175 },
  Matunga: { lat: 19.0268, lng: 72.8534 },
  'Nala Sopara': { lat: 19.4618, lng: 72.7982 },
  Karad: { lat: 17.2896, lng: 74.1818 },
