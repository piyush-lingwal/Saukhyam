...
const careathonSteps = [
  ...
  },
  {
    ...
    desc: 'After a full year of successful implementation, the college is invited to become a Nodal CARE College, representing the top 5% of all CARE campuses in India.',
  ...
  },
  {
    ...
    desc: 'Ambassadors graduate and new teams are formed each year. The movement becomes self-sustaining, ensuring CARE lives beyond any single batch of students.',
